...
def training():
    ...
    np.array(test_loss)
    np.array(test_ber)
    np.savetxt("train_loss 10db 8 pilot", train_loss, newline=" ")
    np.savetxt("train_ber 10db 8 pilot", train_ber, newline=" ")
    np.savetxt("test_loss 10db 8 pilot", test_loss, newline=" ")
    np.savetxt("test_ber 10db 8 pilot", test_ber, newline=" ")
    print("optimization finished")
    model00Save = "resnet estimate para 00 10db 8pilot.pth"
    model01Save = "resnet estimate para 01 10db 8pilot.pth"
    model10Save = "resnet estimate para 10 10db 8pilot.pth"
    model11Save = "resnet estimate para 11 10db 8pilot.pth"
